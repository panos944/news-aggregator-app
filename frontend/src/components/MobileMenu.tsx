          ...
          {user && (
            <div className="flex flex-col items-center space-y-3 pt-4 border-t border-white/20 w-full max-w-xs">
              ...
              <button
                ...
                type="button"
                className="flex items-center space-x-2 px-4 py-2 rounded-md text-sm font-medium bg-red-600 text-white hover:bg-red-800 transition-colors cursor-pointer"
              >
                <LogOut size={16}/>
